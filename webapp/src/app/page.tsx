          ...
          <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="p-10">
              ...
              <div className="space-y-4">
                <p>このゲームは基本ルールをすごろくとし、そこにしりとりの要素を加えたものです。</p>
                <ol className="list-decimal ml-5">
                  <li>しりとりは「り」から開始。さいころを振る順番はランダムで決定。</li>
                  <li>サイコロの出目に対応した文字数でしりとりを行う（例：出目が3なら「リンゴ」など）。</li>
                  <li>
                    次の人もサイコロを振って前の人の言葉に応じたしりとりを同様に行う。制限時間は<a className="text-red-500">30秒</a>。
                    <ul className="list-disc ml-5">
                      <li>正しく回答できない、制限時間を超える、指定の文字数で答えられない場合はその人は進めない。</li>
                      <li>辞書APIで判定。不正な回答には「回答が遅い」「文字数が足りない」「辞書にない言葉」がある。</li>
                      <li>正しい回答を行えた場合のみ、出目の数だけ進む。全員が同じ文字で回答できない場合、ランダムで先頭の文字が変更される。</li>
                    </ul>
                  </li>
                ...
                <div className="pt-4">
                  ...
                  <p>ここに特殊マスの効果を説明します。例えば、特定のマスに止まると○○の効果が発動します。</p>
                </div>
              </div>
            </DialogContent>
          </Dialog>
